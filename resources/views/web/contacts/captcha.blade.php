...
<label for="math" class="control-label" style="@if (isset($color)) color: {{$color}}; @endif direction: ltr;text-align: left;"> @lang('site.solution')  <?php echo $num1 . "&nbsp;" . operand($o) . "&nbsp;" . $num2 . ""; ?> </label><br>
