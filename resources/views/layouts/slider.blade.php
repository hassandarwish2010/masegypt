...
<section class="wpb_row vc_row-fluid no-padding left_dir dir-ltr"  >
    <div class="row"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper "  ><link href="http://fonts.googleapis.com/css?family=Dosis:300%7CRaleway:300" rel="stylesheet" property="stylesheet" type="text/css" media="all">

                    <div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullscreen-container back-slider" data-source="gallery">
                        ...
                        <div id="rev_slider_1_1" class="rev_slider fullscreenbanner"  data-version="5.4.8">
                            <ul style="">    <!-- SLIDE  -->
                                ...
                                <li data-index="rs-{{$index}}" data-transition="parallaxtoright" data-slotamount="10" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="800"  data-thumb="{{$banner->image}}"  data-delay="5000"  data-rotate="0"  data-saveperformance="off"
                                    ...
                                    <!-- MAIN IMAGE -->
                                    <img src="{{$banner->image}}"  alt="{{ $banner->en_title }}" title="wide8"  width="1920" height="1100" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                    <!-- LAYERS -->

                                    <!-- LAYER NR. 1 -->
                                    <div class="tp-caption   tp-resizeme  big-white slid-sty1"
...
{{--LATEST--}}
                                    ...
                                    <!-- LAYER NR. 2 -->
                                    <div class="tp-caption   tp-resizeme  ultra-big-white slid-sty2" id="slide-1-layer-2" data-x=""
                                         ...
                                         >
                                         @php $banner_title = $lang.'_title'@endphp <h1 class="t-right w-text" >{{ $banner->$banner_title }}</h1>

                                     </div>
                                    
                                    <!-- LAYER NR. 3 -->
                                    <div class="tp-caption   tp-resizeme  text-center slid-sty3"
                                         id="slide-1-layer-7"
                                         data-x=""
                                         data-y="310"
                                         data-width="['auto']"
                                         ...
                                         >
                                         @php $description = $lang.'_description'@endphp 
                                       <p class="t-right w-text-desc">  {{ str_replace ('&nbsp;' , ' ' , strip_tags ( $banner->$description)) }}</div>
                                    </p>
                                    <!-- LAYER NR. 4 -->
                            ...
                            <div class="tp-bannertimer tp-bottom js-sty"></div>
                        </div>
                        <script>var htmlDiv = document.getElementById("rs-plugin-settings-inline-css"); var htmlDivCss="";
                            if(htmlDiv) {
                                htmlDiv.innerHTML = htmlDiv.innerHTML + htmlDivCss;
