                        ...
                        <div class="grid-item residential  none">
                            ...
                            <div class="item residential ">
                                <div class="picframe">
                                    ...
                                    <img width="700" alt="{{ $projects[0]->en_name }}" height="466" src="{{asset('public/uploads/thumbs/'.$projects[0]->image)}}"
                        ...
                        <div class="grid-item hospitaly  large-width">
                            ...
                            <div class="item hospitaly ">
                                <div class="picframe">
                                    ...
                                    <img width="800" alt="{{ $projects[1]->en_name }}" height="343" src="{{asset('public/uploads/thumbs3/'.$projects[1]->image3)}}"
                        ...
                        <div class="grid-item hospitaly  large-height">
                            ...
                            <div class="item hospitaly ">
                                <div class="picframe">
                                    ...
                                    <img width="300" alt="{{ $projects[2]->en_name }}" height="466" src="{{asset('public/uploads/thumbs2/'.$projects[2]->image2)}}" class="attachment-full size-full wp-post-image" alt="{{ $projects[2]->en_name }}" srcset="{{asset('public/uploads/thumbs2/'.$projects[2]->image2)}} 300w, {{asset('public/uploads/thumbs2/'.$projects[2]->image2)}} 193w" sizes="(max-width: 300px) 100vw, 300px" />
                                </div>
                            </div>
                            @endisset
                        ...
                        <div class="grid-item residential  none">
                            ...
                            <div class="item residential ">
                                <div class="picframe">
                                    ...
                                    <img width="700" alt="{{ $projects[3]->en_name }}" height="466" src="{{asset('public/uploads/thumbs/'.$projects[3]->image)}} " class="attachment-full size-full wp-post-image"
                            ...
                            <div class="item office ">
                                <div class="picframe">
        	                        ...
        	                        <span class="overlay">
                                     ...
                                     <img width="700" alt="{{ $projects[4]->en_name }}" height="466" src="{{asset('public/uploads/thumbs2/'.$projects[4]->image2)}}" class="attachment-full size-full wp-post-image" alt="{{ $projects[4]->en_name }}" srcset="{{asset('public/uploads/thumbs2/'.$projects[4]->image2)}} 700w, {{asset('public/uploads/thumbs2/'.$projects[4]->image2)}} 300w" sizes="(max-width: 700px) 100vw, 700px" />
                                 </div>
                            </div>
                            @endisset
                        ...
                        <div class="grid-item commercial  none">
                            ...
                            <div class="item commercial ">
                                <div class="picframe">
                                    ...
                                    <img width="700" alt="{{ $projects[5]->en_name }}" height="466" src="{{asset('public/uploads/thumbs/'.$projects[5]->image)}}" class="attachment-full size-full wp-post-image" alt="{{ $projects[5]->en_name }}" srcset="{{asset('public/uploads/thumbs/'.$projects[5]->image)}} 700w, {{asset('public/uploads/thumbs/'.$projects[5]->image)}} 300w" sizes="(max-width: 700px) 100vw, 700px" />							                </div>
                            </div>
                            @endisset
                        ...
                        <div class="grid-item office  large-width">
                            ...
                            <div class="item office ">
                                <div class="picframe">
                                    ...
                                    <img width="800" alt="{{ $projects[6]->en_name }}" height="343" src="{{asset('public/uploads/thumbs3/'.$projects[6]->image3)}}" class="attachment-full size-full wp-post-image" alt="{{ $projects[6]->en_name }}" srcset="{{asset('public/uploads/thumbs3/'.$projects[6]->image3)}} 800w, {{asset('public/uploads/thumbs3/'.$projects[6]->image3)}} 300w, {{asset('public/uploads/thumbs3/'.$projects[6]->image3)}} 768w" sizes="(max-width: 800px) 100vw, 800px" />
                                 </div>
                            </div>
                            @endisset
                        ...
                        <div class="grid-item residential  none">
                            ...
                            <div class="item residential ">
                                <div class="picframe">
                                    ...
                                    <img width="700" alt="{{ $projects[7]->en_name }}" height="466" src="{{asset('public/uploads/thumbs/'.$projects[7]->image)}} " class="attachment-full size-full wp-post-image" alt="{{ $projects[7]->en_name }}" srcset="{{asset('public/uploads/thumbs/'.$projects[7]->image)}}  700w, {{asset('public/uploads/thumbs/'.$projects[7]->image)}}  300w" sizes="(max-width: 700px) 100vw, 700px" />							                </div>
                            </div>
                            @endisset
                            @endif
                            <!-- close gallery item -->
