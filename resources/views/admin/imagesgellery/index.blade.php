...
<div class="row">
  <div class="col-sm-12">
      <div class="white-box">
          <a class="box-title m-b-1 btn btn-info btn-rounded" href="{{ route('images-gallery.create') }}"> add new</a>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <td class="text-nowrap">
                              ...
                              {{--</a>--}}
                              <a href="{{ route('images-gallery.edit', $img_gallery->id) }}" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                              <a href="javascript:void(0)" class="delete_confirmation" data-toggle="modal" data-target="#myModal" data-action="{{ route('images-gallery.destroy', $img_gallery->id) }}">
